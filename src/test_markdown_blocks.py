...
"""
    ...
    def test_block_to_block_heading6(self):
        md = "###### I LOVE HEADINGS"
        
        blocktype = block_to_block_type(md)
        self.assertEqual(blocktype, BlockType.HEADING)

    def test_block_to_block_heading7(self):
        md = "####### I LOVE HEADINGS"
    ...
    def test_block_to_block_unorderedlist(self):
        md = "- This is a list\n- with items"
        blocktype = block_to_block_type(md)
        self.assertEqual(blocktype, BlockType.ULIST)

    def test_block_to_block_unorderedlist_invalid(self):
        md = "- This is a list\n-with items"
        blocktype = block_to_block_type(md)
        self.assertEqual(blocktype, BlockType.PARAGRAPH)

    def test_block_to_block_orderedlist(self):
        md = "1. This is a list\n2. with items"
        blocktype = block_to_block_type(md)
        self.assertEqual(blocktype, BlockType.OLIST)

    def test_block_to_block_orderedlist_invalid(self):
        md = "1. This is a list\n3.with items"
        blocktype = block_to_block_type(md)
        self.assertEqual(blocktype, BlockType.PARAGRAPH)
